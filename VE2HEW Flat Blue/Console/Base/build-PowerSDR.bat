...
REM New Additions
copy %up1% %skinpath%btnBandHF1-0.png
copy %dn1% %skinpath%btnBandHF1-1.png
...
copy %up1% %skinpath%btnTNF-0.png
copy %dn1% %skinpath%btnTNF-1.png
copy %up1% %skinpath%btnTNFAdd-0.png
copy %dn1% %skinpath%btnTNFAdd-1.png

copy %apf0% %skinpath%chkCWAPFEnabled-0.png
copy %apf1% %skinpath%chkCWAPFEnabled-1.png
...
copy %qsk0% %skinpath%chkQSK-0.png
copy %qsk1% %skinpath%chkQSK-1.png

copy %up2% %skinpath%chkRxAnt-0.png
copy %dn2% %skinpath%chkRxAnt-1.png

copy %up1% %skinpath%chkTNF-0.png
copy %dn1% %skinpath%chkTNF-1.png

copy %up1% %skinpath%chkVAC1-0.png
copy %dn1% %skinpath%chkVAC1-1.png
copy %up1% %skinpath%chkVAC2-0.png
copy %dn1% %skinpath%chkVAC2-1.png

copy %up2% %skinpath%chkVFOBLock-0.png
copy %dn2% %skinpath%chkVFOBLock-1.png

copy %apf0% %skinpath%ptbCWAPFEnabled-0.png
copy %apf1% %skinpath%ptbCWAPFEnabled-1.png

copy %slideback% %skinpath%ptbCWAPFBandwidth-back.png
copy %slideback% %skinpath%ptbCWAPFFreq-back.png
copy %slideback% %skinpath%ptbCWAPFGain-back.png
copy %slideback% %skinpath%ptbFMMic-back.png
copy %slideback% %skinpath%ptbRX1AF-back.png
copy %slideback% %skinpath%ptbRX2AF-back.png

copy %slidehead% %skinpath%ptbCWAPFBandwidth-head.png
copy %slidehead% %skinpath%ptbCWAPFFreq-head.png
copy %slidehead% %skinpath%ptbCWAPFGain-head.png
copy %slidehead% %skinpath%ptbFMMic-head.png
copy %slidehead% %skinpath%ptbRX1AF-head.png
copy %slidehead% %skinpath%ptbRX2AF-head.png

copy %up1% %skinpath%radBandGEN1-0.png
copy %dn1% %skinpath%radBandGEN1-1.png
copy %up1% %skinpath%radBandGEN2-0.png
copy %dn1% %skinpath%radBandGEN2-1.png
copy %up1% %skinpath%radBandGEN3-0.png
copy %dn1% %skinpath%radBandGEN3-1.png
copy %up1% %skinpath%radBandGEN4-0.png
copy %dn1% %skinpath%radBandGEN4-1.png
copy %up1% %skinpath%radBandGEN5-0.png
copy %dn1% %skinpath%radBandGEN5-1.png
copy %up1% %skinpath%radBandGEN6-0.png
copy %dn1% %skinpath%radBandGEN6-1.png
copy %up1% %skinpath%radBandGEN7-0.png
copy %dn1% %skinpath%radBandGEN7-1.png
copy %up1% %skinpath%radBandGEN8-0.png
copy %dn1% %skinpath%radBandGEN8-1.png
copy %up1% %skinpath%radBandGEN9-0.png
copy %dn1% %skinpath%radBandGEN9-1.png
copy %up1% %skinpath%radBandGEN10-0.png
copy %dn1% %skinpath%radBandGEN10-1.png
copy %up1% %skinpath%radBandGEN11-0.png
copy %dn1% %skinpath%radBandGEN11-1.png
copy %up1% %skinpath%radBandGEN12-0.png
copy %dn1% %skinpath%radBandGEN12-1.png
copy %up1% %skinpath%radBandGEN13-0.png
copy %dn1% %skinpath%radBandGEN13-1.png
...
copy %tx0% %skinpath%chkVFOATX-0.png
copy %tx1% %skinpath%chkVFOATX-1.png
copy %tx0% %skinpath%chkVFOBTX-0.png
copy %tx1% %skinpath%chkVFOBTX-1.png
...
copy %up2% %skinpath%chkSquelch-0.png
copy %up2% %skinpath%chkRX2Squelch-0.png
...
copy %dn2% %skinpath%chkSquelch-1.png
copy %dn2% %skinpath%chkRX2Squelch-1.png
